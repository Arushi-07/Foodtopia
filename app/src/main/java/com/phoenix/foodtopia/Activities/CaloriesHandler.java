...
import com.phoenix.foodtopia.Fragments.NutrientFragment;
import com.phoenix.foodtopia.R;

public class CaloriesHandler extends AppCompatActivity {
    ...
    @Override
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_calories_handler);
            init();
            changeStatusBarColor();
            nutrient= new NutrientFragment();
            changeFragment("askNutrients",nutrient);
            ...
            thumbView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    zoomImageFromThumb(thumbView, R.drawable.nutrient_chart);
                }
            });
            ...
            proceed.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                  //  String cal=caloriesText.getText().toString();
                    ...
                    startActivity(nutrient.getData(intent,calorie,fat,protein,iron,calcium));
                }
            });
        }
        ...
        public void init()
        {
            intent = new Intent(this,OrderHandler.class);
        ...
        private void zoomImageFromThumb(final View thumbView, int imageResId) {
           ...
           /* final ImageView expandedImageView = (ImageView) findViewById(
            ...
            set.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationCancel(Animator animation) {
                    mCurrentAnimator = null;
                    Log.e("anim","animation cancelled");
                }
            });
            set.start();
            mCurrentAnimator = set;
